...
class Game
{
    ...
    public function renderSWF()
    {
        return'
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://www.adobe.com/go/getflashplayer" width="100%" height="100%" align="middle">
                ...
                <embed width="100%" height="100%" src="/new/games/'. $this->game .'" width="100%" height="100%" align="middle" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
            </object>
        ';
    }
    ...
    public function renderUnity()
    {
        ...
        <object id="UnityObject" classid="clsid:444785F1-DE89-4295-863A-D46C3A781394"
            ...
            <embed id="UnityEmbed" src="/new/games/'. $this->game .'" width="100%" height="100%"
